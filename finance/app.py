...
def buy():
    ...
    current_cash = db.execute("SELECT cash FROM users WHERE id = ?", f{id = user_id})
...
# +----+----------+--------------------------------------------------------------------------------------------------------+-------+
# | 1  | nat      | pbkdf2:sha256:600000$cFxRK2TL3GPv3dvi$28ac2675e8a7eb841385bf67edbc120b4cdcff3f403b3666dd15ffe116271784 | 10000 | 1234
# | 2  | nataly   | pbkdf2:sha256:600000$mwZIOtpezAwi6KvY$f38f60712514819f522de47b0989a5580d924d21e3311f3ca792372cd98321e8 | 10000 |
# | 3  | alona    | pbkdf2:sha256:600000$QdRa93Z0UZsgHitF$14bd5e5a60c0029fd1429c5848ef3e84dbaaa0a5a71b4388436aec4a9f8624e1 | 10000 |
# | 4  | max      | pbkdf2:sha256:600000$AwlxJDvhMY50xyj2$0b534c7ca112a3db00fac0b123569fdba3a0d49eacad2e4151105ff224b077d6 | 10000 |
