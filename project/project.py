...
def main():
    ...
    while True:
        try:
            ...
            # list_products = [{'Name': current_product.name, 'Icon': current_product.icon, 'Price $': current_product.price, 'Quantity': current_product.quantity, 'Sum $': current_product.sum}]
